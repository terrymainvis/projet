...
public class AnnonceController {
	...
	/**
	 * pour la cr�ation d'une annonce
	 ...
	 * 
	 * @param annform
	 * @return le formulaire de cr�ation d'une annonce, apr�s que l'on ait choisi une cat�gorie
	 */
	@RequestMapping("new/form")
	public ModelAndView getForm(@ModelAttribute("annform") AnnonceForm annform) {
		
		//si on arrive sur le formulaire sans passer par le choix de cat�gorie --> redirige
